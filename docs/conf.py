...
version, release = find_version("..", "dead_sfs", "__init__.py")
...
latex_documents = [
    (master_doc, 'deadSFS.tex', 'deadSFS Documentation',
...
man_pages = [
    (master_doc, 'deadSFS', 'deadSFS Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'deadSFS', 'deadSFS Documentation', author, 'deadSFS',
...
def run_apidoc(_):
    ...
    module = os.path.join(cur_dir, "..", "dead_sfs")
